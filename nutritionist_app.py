...
#st.set_page_config(page_title="Health Management: Nutrition Calculator & Nutrition Diet Planner")
st.image('./logo.jpg', width=70)
st.header("Health: Nutrition Calculator & Nutrition Diet Planner")

######################################################################################
section_choice1 = st.radio("Choose Section:", ("Nutrition Diet Planner"))
...
#If choice is Nutrition Diet Planner
if section_choice1 == "Nutrition Diet Planner":
